...
class pdfService():
    ...
    def parsePDF( self, srcFile, pageno ):
        ...
        self.getPages( trailer["Root"], pages )
        ...
        self.getCmapList( pages, cmaplist, contentMap) 
        ...
        self.processPage( pageno, pages, cmaps, cmaplist, contentMap, "F:/F_t_tmp/tmp1/"+pageno + "_content.txt")
...
<</Count 266/Kids[3 0 R。。。298 0 R 299 0 R]/Type/Pages>>
     ...
     * 
    '''
    def getPageleaf( self, pageObj, pageleaf ):
        try:
            retcode = -1
     ...
     *      self.isType0()
    '''
    def getCmapList( self, pages, cmaplist, contentMap):
        try:
     ...
     */
    '''
    def processPage( self, PageNo, pages, cmaps, cmaplist, contentMap, desFile ):
        try :
            #cmap = {}
            desbuf = ''
